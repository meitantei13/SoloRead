...
module GuestSampleData
  module BookSamples
    DATA = [
      ...
      {
        title: "ひとり温泉、思い立ったら吉日",
        author: "山崎 まゆみ",
        content: <<~TEXT,
          全国各地の温泉を巡る体験談を通して、旅の楽しみ方や心の解放感が伝わってくる一冊。
          予定に縛られず、気ままに出かけたくなる気持ちを後押ししてくれる。
        TEXT
        genre: "趣味",
      },
      {
        title: "コーヒーが冷めないうちに始める自宅焙煎",
        author: "川口 泰範",
        content: <<~TEXT,
          自宅でコーヒーを楽しむための基礎から実践までを丁寧に解説。
          特別な道具がなくても始められる点が魅力で、日常の楽しみを広げてくれる内容だった。
        TEXT
        genre: "趣味",
      },
    ].freeze
