...
![Image](https://github.com/user-attachments/assets/1a78f724-8e22-4ac1-bd04-48a0a2697acc)
...
バックエンドでは RSpec によるモデル・リクエストスペックを作成し、機能追加や修正時にデグレードを防止できる構成としています。また、Rubocop によるコードスタイルチェックを行っています。
