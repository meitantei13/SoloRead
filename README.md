...
- **書籍検索（Google Books API連携）**<br>
  Google Books API と連携し、書名や著者名で書籍を検索し登録できます。
...
- **ノート一覧・タグ**<br>
  読書中の感想を随時記録し、登録時にタグ登録が可能。
  登録したノートを一覧で表示。タグでの絞り込み検索にも対応。

### 振り返り

- **読書冊数の可視化**  
  今月・今年・累計の読書量、月平均読書量を確認可能。
...
- **ノート詳細に紐ついている本のタイトルを表示**
  実際の利用者から、「ノート一覧から各ノートを見ると、どの本の記録か分からない」という意見をいただきました。
  ノート詳細ダイアログを開くことによって、ノートに紐づいている本のタイトルを表示に対応しました。
  また、表示されている本のタイトルをクリックすることで、本の詳細ページに遷移する仕様にしました。
